...
const sololaki = {
  ...
  image: {
    style: {
      backgroundImage: 'radial-gradient(rgba(244, 233, 217, .25), rgba(42, 81, 61, .65), rgba(0, 0, 0, .65)), url(' + SOLOLAKI_JPG + ')',
      cursor: 'pointer',
...
const rustaveli = {
  ...
  image: {
    style: {
      backgroundImage: 'radial-gradient(rgba(244, 233, 217, .25), rgba(42, 81, 61, .65),rgba(0, 0, 0, .65)),url(' + RUSTAVELI_JPG + ')',
