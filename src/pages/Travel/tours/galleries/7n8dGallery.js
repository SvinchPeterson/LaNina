  ...
  footer: {
    ...
    bookContainer: {
      book: {
        on: {
          click: (event, element, state) => {
            state.active_8d_TourMail
              ? state.update({ active_8d_TourMail: false, active_8d_TourBook: false, active_8d_TourBooked: true })
              : state.update({ active_8d_TourMail: true })
          }
        },
        ...
        class: {
          ...
          show2: (element, state) => state.active_8d_TourBooked
            ? {
              pointerEvents: 'none',
              opacity: '.55'
            }
        ...
        span: {
          class: {
            show: (element, state) => state.active_8d_TourBook
