...
export const galleryYellowCouch = {
  ...
  ...[
    ...
    {
      style: {
        '@media only screen and (min-width: 1226px)': { backgroundImage: 'url(' + LIVINGROOM3_JPG + ')', display: 'none' },
        '@media only screen and (max-width: 1225px)': { backgroundImage: 'url(' + LIVINGROOM3_TABLET_JPG + ')', display: 'none' },
        '@media only screen and (max-width: 768px)': { backgroundImage: 'url(' + LIVINGROOM3_MOBILE_JPG + ')', display: 'none' }
      }
    },
    {
      style: {
    ...
    {
      style: {
        '@media only screen and (min-width: 1226px)': { backgroundImage: 'url(' + CHILL_JPG + ')', display: 'none' },
        '@media only screen and (max-width: 1225px)': { backgroundImage: 'url(' + CHILL_TABLET_JPG + ')', display: 'none' },
        '@media only screen and (max-width: 768px)': { backgroundImage: 'url(' + CHILL_MOBILE_JPG + ')', display: 'none' }
      }
    },
    {
      style: {
